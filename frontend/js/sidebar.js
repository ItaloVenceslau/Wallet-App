    ...
    sidebarContainer.innerHTML = `
      <aside class="sidebar">
        ...
        <div class="sidebar-user-profile" style="display: flex; align-items: center; gap: 12px; padding: 16px 8px; margin-top: auto; border-top: 1px solid rgba(255,255,255,0.08); margin-bottom: 8px;">
          <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=BudgetUser" alt="Avatar" style="width: 36px; height: 36px; border-radius: 50%; background: var(--grad-accent); padding: 2px;">
